...
class Mesh():
    ...
    def load_to_gpu(self):
        ...
        # activation l'utilisation des donnees de positions (le 0 correspond à la location dans le vertex shader)
        GL.glEnableVertexAttribArray(0)
        # indication sur le buffer courant (dernier vbo "binde") est utilise pour les positions des sommets
